...
### What Was Changed?
Kode dipisah menjadi tiga bagian utama yaitu EmbeddingService, DocumentStore dan RagWorkflow agar logika bisnis, penyimpanan data dan API tidak lagi bercampur dalam satu file. Struktur ini membuat alurnya lebih jelas tanpa mengubah behaviour aplikasi.
